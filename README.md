...
The style of ActionSheet is defined in [lib/styles.js](https://github.com/arjan-zuidema/react-native-actionsheet-ex/blob/master/lib/styles.js). We can pass the `styles` prop to cover default style. See [Example](https://github.com/arjan-zuidema/react-native-actionsheet-ex/blob/master/example/app/ExampleB.js#L48) .
